...
<section class="container mx-auto px-6 py-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
        <div class="lg:col-span-2 border border-gray-300 p-4 rounded-lg shadow-sm">
            ...
            <p class="text-gray-500 text-sm mb-2"><?php echo date("F d, Y"); ?></p>
            <div class="flex justify-between items-start">
                <h3 class="font-bold text-lg mb-2">Comprehensive Geriatric Training</h3>
                <i class="far fa-bookmark text-gray-400 cursor-pointer hover:text-brandBlue"></i>
            </div>
            <p class="text-sm text-gray-600 mb-4">
                A lecture on GERIATRIC SYNDROME was conducted by Dr. Cathy Usman during the Comprehensive Geriatric Training among health care providers...
            </p>
            <div class="border-t border-gray-200 pt-3 flex items-center text-gray-400 text-xs">
                <i class="far fa-eye mr-2"></i> 102,100,210
            </div>
        </div>
        ...
        <div class="lg:col-span-3 flex flex-col space-y-4">
            <?php 
            $news_items = [
                ["title" => "Geriatric Syndrome Lecture", "date" => "October 23, 2024", "desc" => "Dr. Cathy Usman discusses syndrome management..."],
                ["title" => "Health Care Providers Meet", "date" => "October 24, 2024", "desc" => "City Inn Hotel hosted the annual provider meeting..."],
                ["title" => "Senior ID Distribution", "date" => "October 25, 2024", "desc" => "New digital IDs are now available for claiming..."]
            ];
            ...
            <div class="flex flex-col sm:flex-row border border-gray-300 p-3 rounded-lg shadow-sm bg-white hover:shadow-md transition">
                ...
                <div class="sm:ml-4 mt-2 sm:mt-0 flex-1">
                    <p class="text-xs text-gray-500"><?php echo $news['date']; ?></p>
                    <h4 class="font-bold text-md"><?php echo $news['title']; ?></h4>
                    <p class="text-xs text-gray-600 mt-1"><?php echo $news['desc']; ?></p>
                    <a href="#" class="text-xs text-gray-400 underline mt-2 block hover:text-brandBlue">Read more...</a>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
    ...
    <div class="text-center mt-6">
        <a href="#" class="text-red-500 underline text-lg hover:text-red-700">Click here to read more news items....</a>
    </div>
</section>
