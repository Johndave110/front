<header class="bg-white shadow-sm py-4 px-8 flex justify-between items-center sticky top-0 z-40">
    ...
    <div class="flex items-center space-x-4 relative">
        ...
        <div class="text-right hidden sm:block">
            <p class="text-sm font-bold text-gray-900">Space1000</p>
            <p class="text-xs text-gray-500">Social Worker Coordinator</p>
        </div>
        ...
        <div id="user-menu-dropdown" class="hidden absolute right-0 top-14 w-48 bg-white rounded-lg shadow-xl border border-gray-100 z-50 overflow-hidden animation-fade-in">
            ...
            <a href="../landingpage/index.php" class="px-4 py-3 text-sm text-gray-800 hover:bg-red-50 hover:text-red-600 flex items-center gap-3 transition group">
                <div class="w-6 flex justify-center">
