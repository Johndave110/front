        ...
        <div id="step-1-content" class="fade-in">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-10">
                ...
                <div class="flex flex-col md:flex-row justify-between md:items-center mb-8 gap-4">
                    ...
                    <button class="border border-gray-300 text-gray-500 text-sm px-6 py-2 rounded-md bg-white hover:bg-gray-50 w-full md:w-auto text-center">Input Name</button>
                </div>
